...
class Trainer(object):
  def __init__(self, cuda, model, optimizer,
         train_loader, out, max_iter,
         size_average=False, interval_validate=None, args=None, input_size=(1024, 512)):
  ...
  def adjust_learning_rate(self, optimizer, i_iter, args):
    lr = self.lr_poly(args.learning_rate, i_iter, args.num_steps, args.power)
